...
let palabra3 = prompt("Ingrese la tercer palabra")

console.log("El largo de la primer palabra es:", palabra1.length)
console.log("El largo de la segunda palabra es:", palabra2.length)
console.log("El largo de la tercer palabra es:", palabra3.length)